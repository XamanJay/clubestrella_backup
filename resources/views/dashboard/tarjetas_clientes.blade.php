...
<div class="container">
    ...
    @endif
    <h1 class="dashboard-h"><i class="fas fa-id-card edit-icon"></i>Tarjetas Club Estrella</h1>
    <table id="tarjetas" class="display hover center-text" style="width:100%">
        <thead>
            <tr style="text-align:center;">
                <th class="gold-T">QR code</th>
                ...
                <th class="gold-T">Fecha Enrolamiento</th>
            </tr>
        </thead>
        <tfoot>
            <tr style="text-align: center;">
    ...
    <script type="text/javascript"> 
        ...
        $(document).ready(function() {
            ...
            var table = $('#tarjetas').DataTable( {
                ...
                ajax: '/plugins/datatable-editor/lib/Tarjetas.php',
                responsive: {
                    details: true
                },
                dom: 'Bfrtip',
                columns: [
                    { data: 'clientes.qr_code' },
