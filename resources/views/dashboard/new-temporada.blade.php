...
<div class="container box-edit">
    ...
    @endif
    <form action="{{ route('store.temporada',App::getLocale()) }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    <label for="numero_cuenta">Fecha Inicio<span>*</span></label>
                    <input class="datedropper-init form-control" type="text" name="startDate" data-dd-format="d-m-Y" placeholder="dd/mm/YY" value="{{ Request::old('startDate') ?? "" }}">
                </div>
            </div>
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    <label for="nombre_cuenta">Fecha Termina<span>*</span></label>
                    <input class="datedropper-init form-control" type="text" name="endDate" data-dd-format="d-m-Y" placeholder="dd/mm/YY" value="{{ Request::old('endDate') ?? "" }}">
                </div>
            </div>
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    <label for="tarifa_base">Tarifa Base<span>*</span></label>
                    <input type="text" class="form-control" name="tarifa_base" id="tarifa_base" value="{{ Request::old('tarifa_base') ?? ""}}">
                </div>
            </div>
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    <label for="tarifa_pax">Tarifa Pax<span>*</span></label>
                    <input type="text" class="form-control" name="tarifa_pax" id="tarifa_pax" value="{{ Request::old('tarifa_pax') ?? ""}}">
                </div>
            </div>
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    <label for="tarifa_alimentos">Tarifa Alimentos</label>
                    <input type="text" class="form-control" name="tarifa_alimentos" id="tarifa_alimentos" value="{{ Request::old('tarifa_alimentos') ?? ""}}">
                </div>
            </div>
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    <label for="tarifa_upgrade_habitacion">Tarifa Upgrade Habitación</label>
                    <input type="text" class="form-control" name="tarifa_upgrade_habitacion" id="tarifa_upgrade_habitacion" value="{{ Request::old('tarifa_upgrade_habitacion') ?? "" }}">
                </div>
            </div>        
            <div class="col-12 col-sm-6">
                <div class="form-group">
