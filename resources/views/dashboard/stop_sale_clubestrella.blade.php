...
@section('content')
<div class="container">
    <h1 class="dashboard-h">Lista de StopSales Club Estrella</h1>
    <a href="{{ route('create.stop.sale.clubestrella',App::getLocale()) }}" class="btn btn-detail" style="margin-bottom: 30px;">
        <i class="fas fa-plus"></i>Nuevo StopSale Club Estrella
    </a>
    @if(session('success'))
    ...
    @endif
    <table id="stop_sale_clubestrella" class="display hover center-text" style="width:100%">
        <thead>
...
@section('page-scripts')
    ...
    <script type="text/javascript"> 
            ...
            return '<div class="row detail_cargo">'+
                    '<div class="col-12 col-sm-3">'+
                        '<div class="row" style="padding:0px;margin:0px;">'+
                            '<div class="col-12">'+
                                '<a href="'+url+'/es/destroy-stop-sale-clubestrella/'+id+'" class="btn btn-detail">Eliminar StopSale</a>'+
                            '</div>'+
                        '</div>'+
                    '</div>'+
                '</div>';
        ...
        $(document).ready(function() {
            ...
            var table = $('#stop_sale_clubestrella').DataTable( {
                language: {
                    url: "/js/spanish.lang"
                },
                ajax: '/plugins/datatable-editor/lib/StopSaleClubEstrella.php',
                responsive: {
                    details: true
                },
                dom: 'Bfrtip',
            ...
            $('#stop_sale_clubestrella tbody').on('click', 'td.details-control', function () {
