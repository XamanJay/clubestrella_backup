...
<div class="container box-edit">
    <div class="row">
        <div class="col-12">
            <ul class="breadcrumbCustom">
                ...
                <li>-></li>
                <li>Stop Sale Club Estrella</li>
            </ul>
        </div>
    </div>
    <h1 class="dashboard-h"><i class="fas fa-pencil-alt edit-icon"></i>Nuevo Stop Sale Club Estrella</h1>
    @if($errors->any())
    ...
    @endif
    <form action="{{ route('store.stop.sale.clubestrella',App::getLocale()) }}" method="POST" class="formStyle">
        @csrf
        <div class="row">
            ...
            <div class="col-12 col-sm-4">
                <div class="form-group">
                    ...
                    <a href="{{ route('stop.sale.comercial',App::getLocale()) }}" class="btn btn-danger">Cancelar</a>
                </div>
            </div>
        </div>
    </form>
